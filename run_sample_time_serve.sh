...
# vllm serve /share/home/syji/model/deepseek-ai/DeepSeek-R1-Distill-Qwen-7B --generation-config vllm --chat_template /share/home/syji/code/BoX/chat_template/origin.jinja --port 8000 --tensor_parallel_size 1
